...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+5,(vlSelf->wr));
    bufp->chgBit(oldp+6,(vlSelf->rd));
    bufp->chgBit(oldp+7,(vlSelf->mic_signal));
    bufp->chgCData(oldp+8,(vlSelf->delayed_signal),8);
    bufp->chgCData(oldp+9,(vlSelf->sigdelay__DOT__address1),8);
    bufp->chgCData(oldp+10,((0xffU & ((IData)(vlSelf->sigdelay__DOT__address1) 
                                      + (IData)(vlSelf->offset)))),8);
    bufp->chgCData(oldp+11,((0x7fU & (- (IData)((IData)(vlSelf->mic_signal))))),8);
}
