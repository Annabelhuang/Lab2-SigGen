...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+8,"mic_signal", false,-1);
    ...
    tracep->declBit(c+8,"mic_signal", false,-1);
    tracep->declBus(c+9,"delayed_signal", false,-1, 7,0);
    tracep->declBus(c+10,"address1", false,-1, 7,0);
    ...
    tracep->declBus(c+12,"din", false,-1, 7,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+8,(vlSelf->mic_signal));
    bufp->fullCData(oldp+9,(vlSelf->delayed_signal),8);
    bufp->fullCData(oldp+10,(vlSelf->sigdelay__DOT__address1),8);
    bufp->fullCData(oldp+11,((0xffU & ((IData)(vlSelf->sigdelay__DOT__address1) 
                                       + (IData)(vlSelf->offset)))),8);
    bufp->fullCData(oldp+12,((0x7fU & (- (IData)((IData)(vlSelf->mic_signal))))),8);
